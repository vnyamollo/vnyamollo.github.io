...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Click PDF to download CV",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-pm2-5-prediction",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%76%6E%79%61%6D%6F%6C%6C%6F@%6C%61%6D%61%72.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/vnyamollo# your GitHub user name", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/vnyamollo# your LinkedIn user name", "_blank");
        },
      },{
      id: 'light-theme',
